...
const projectDescriptions = {
  ...
  alternativ: {
    ...
    desc: "Gestion et développement des sites web d'une entreprise spécialisée dans la vente d'équipements professionnels. Création et maintenance de sites WordPress et e-commerce avec personnalisation produit et SEO complet.",
    features: [
