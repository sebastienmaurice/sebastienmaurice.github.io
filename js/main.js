...
(function(){
  const techs = [
    ...
    { name:'TypeScript', svg:`<svg viewBox="0 0 24 24"><rect width="24" height="24" rx="3" fill="#3178C6"/><path d="M13.5 14.5v1.7c.3.1.6.3 1 .3.9 0 1.5-.5 1.5-1.3 0-.7-.4-1.1-1.3-1.5l-.5-.2c-.5-.2-.7-.4-.7-.7s.2-.5.6-.5c.4 0 .7.2.9.5l1-.7c-.4-.7-1-.9-1.9-.9-1.1 0-1.9.7-1.9 1.7 0 .8.5 1.3 1.4 1.7l.5.2c.5.2.7.5.7.8 0 .4-.3.6-.8.6-.5 0-.9-.2-1.2-.7zm-2.5-3H8v1.3h1.5V19h1.4v-6.2h1.5v-1.3z" fill="#fff"/></svg>` },
    { name:'React', svg:`<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="2.1" fill="#61DAFB"/><ellipse cx="12" cy="12" rx="10" ry="3.8" fill="none" stroke="#61DAFB" stroke-width="1.2"/><ellipse cx="12" cy="12" rx="10" ry="3.8" fill="none" stroke="#61DAFB" stroke-width="1.2" transform="rotate(60 12 12)"/><ellipse cx="12" cy="12" rx="10" ry="3.8" fill="none" stroke="#61DAFB" stroke-width="1.2" transform="rotate(120 12 12)"/></svg>` },
    { name:'Next.js', svg:`<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="#000"/><path d="M9.5 8v8l8-8v4.5" stroke="#fff" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>` },
    ...
    { name:'Docker', svg:`<svg viewBox="0 0 24 24"><path fill="#2496ED" d="M13.5 7h2v2h-2zm-3 0h2v2h-2zm-3 0h2v2h-2zm6-3h2v2h-2zm-3 0h2v2h-2zM7.5 7h2v2h-2zm9 3H3c-.1 5 3.4 8.5 8.5 9 6 .5 10.5-4 10.5-9-.5-.1-3.2-.5-5 0z"/></svg>` },
    { name:'Supabase', svg:`<svg viewBox="0 0 24 24"><defs><linearGradient id="supa" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#3ECF8E"/><stop offset="100%" stop-color="#249361"/></linearGradient></defs><path fill="url(#supa)" d="M11.9 3L4 14.5h8.1v6.5l8-11.5h-8.2z"/></svg>` },
